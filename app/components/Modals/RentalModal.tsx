...
const RentalModal = () =>{
        ...
        bodyContent = (
            <div className=" flex flex-col gap-8">
                <Heading
                    ...
                    subtitle="Help the guest locate it"
                />
                <CountrySelect
                    value={location}
    ...
    if(step == STEPS.INFO){
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading 
                    title="Share some basics about this place..."
                    subtitle="What amenaties you have here?"
                />
                <Counter 
                    title="Guests"
        ...
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading
                    ...
                    subtitle="Share some images of the place for the user's reference"
                />
                <ImageUpload 
                    value={imageSrc}
